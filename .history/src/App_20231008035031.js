...
function App() {
  ...
  return (
    <div className="app">
      ...
      <input type="text" value={title} onChange={(e) => handleToChange(e, setTitle)}>omg</input>
      <input type="text" value={time} onChange={(e) => handleToChange(e, setTime)}>a</input>
      <input type="text" value={loc} onChange={(e) => handleToChange(e, setLoc)}>asdf</input>
